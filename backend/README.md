...
## Project Structure
    ...
    ├── tst_layout_editor_s_24873  # Django project configurations
...
1. Clone this repo and `cd tst_layout_editor_s_24873`
...
2. Clone this repo and `cd tst_layout_editor_s_24873`
